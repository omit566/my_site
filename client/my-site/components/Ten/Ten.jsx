...
For Men" {...a11yProps(0)} />
    ...
    <div className='flex gap-[20px] mt-[50px] ml-[700px]'>
        <img className='w-[300px] h-[200px] hover:bg-[#000] hover:opacity-[.7]' src="https://i.ibb.co/DpRkzxv/banner-11.png" alt="" />
        <img className='w-[300px] h-[200px] hover:bg-[#000] hover:opacity-[.7]' src="https://i.ibb.co/LvBNDrw/banner-10.jpg" alt="" />
        </div>
        <div className='flex gap-[20px] ml-[50px] mt-[-200px]'>
        <img className='w-[300px] h-[200px] hover:bg-[#000] hover:opacity-[.7]' src="https://i.ibb.co/XtsD0n6/banner-9.jpg" alt="" />
        <img className='w-[300px] h-[200px] hover:bg-[#000] hover:opacity-[.7]' src="https://i.ibb.co/2NHxvd0/banner-8.jpg" alt="" />
    </div>
    <div>
